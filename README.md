A simple _Retrieval-Augmented Generation_ (RAG) chatbot built using Streamlit, ChromaDB, and the Groq LLM to help you interactively query and summarize your uploaded PDF/TXT documents.
##  Features
